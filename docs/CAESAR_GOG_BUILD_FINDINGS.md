...
| `MINIFONT.PL1` shares PL8's container and descriptors; its pixels are 1 bit each, as the extension says | Definitive (header match; the glyphs decode cleanly as bits, 2026-09-14) |
